...
```bash
# Clone và cài đặt
cd /home/<user>/IdeaProjects/maker8/mcpserver8
python -m venv .venv
...
[Service]
Type=simple
WorkingDirectory=/home/<user>/IdeaProjects/maker8/mcpserver8
Environment=DISPLAY=:0
Environment=MCPSERVER8_ADMIN_PASS=my-secure-password
ExecStart=/home/<user>/IdeaProjects/maker8/mcpserver8/.venv/bin/python -m src.server
Restart=on-failure
RestartSec=5
