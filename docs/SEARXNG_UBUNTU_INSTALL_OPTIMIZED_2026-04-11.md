...
- `/home/<user>/searxng/docker-compose.yml`
- `/home/<user>/searxng/.env`
- `/home/<user>/searxng/core-config/settings.yml`
- `/home/<user>/searxng/core-config/limiter.toml`
...
1. Restore file vào đúng cấu trúc `/home/<user>/searxng`.
2. Chạy lại:
